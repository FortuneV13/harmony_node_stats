...
Enter the below code for a one line installation.
```
cd ~/ && wget https://raw.githubusercontent.com/FortuneV13/harmony_node_stats/main/install.py -O install.py && python3 install.py && rm install.py
```
